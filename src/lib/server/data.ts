...
export const projects: Project[] = [
	...
	{
		title: `Conway's Game of Life Over Time`,
		language: 'Rust',
		tags: [],
		description: `A 3D visualization of Conway's game of life, where the previous cell generations are preserved over time.`,
		url: '/projects/conways-golot',
		githubUrl: 'https://github.com/DanielHZhang/conways_golot',
	},
	{
