        ...
        <Flex flow='column' crossAxis='center'>
          <Flex flow='column' css={{maxWidth: '72rem'}}>
            ...
            <Stack flow='column' spacing='1.6rem' css={{fontSize: '2rem', marginTop: '3.6rem'}}>
              ...
              <p>
                My experience in software development spans across the stack, having built
                substantial frontend and backend web applications. I focus on writing maintainable
                and scalable code that meets project requirements.
              </p>
              <p>
                I deeply enjoy learning, creating, and growing with diverse people and teams. I owe
                a lot of my knowledge to the open source community and adopting an accessible,
